...
SIDEBAR: Compare the tidy-ish code to the commented out xts/zoo code beneath it. Tidy code is much more parsimonious.  Though, to be fair, we are biased to use long-form tidy data because it feeds better into ggplot2.
```{r}
